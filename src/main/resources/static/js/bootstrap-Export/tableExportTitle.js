    ...
    $.fn.tableExport = function (options) {
        ...
        if ( defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt' ) {
            ...
            $(el).filter(function () {
                ...
                var titleName = defaults.fileName;   //excel文件名称
                var titleTr = '';    //标题tr
                ...
                $hrows.each(function () {
                    ...
                    // 增加表头
                    if(rowIndex == 0){
                        titleTr +='<tr><th style="color:rgb(0, 0, 0);font-size:14px;font-weight:700" colspan="'+colspanCount+'" rowspan="1">' + titleName + '</th></tr>';
                        docData +=titleTr;
                    }
